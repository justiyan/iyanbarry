...
The limits are explored further in [what a cyber insurance questionnaire does not tell you](/blog/what-a-cyber-insurance-questionnaire-does-not-tell-you).
...
Record each missing decision or dependency as assigned work. Then test the repaired step. [A tabletop exercise that tests decisions rather than memory](/blog/a-tabletop-exercise-that-tests-decisions-rather-than-memory) offers a fuller structure without turning the rehearsal into a technical examination.
