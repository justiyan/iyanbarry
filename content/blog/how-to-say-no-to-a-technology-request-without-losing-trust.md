...
The boundaries in [delegating technology decisions](/blog/the-cost-of-keeping-every-technology-decision-with-the-cio) help make that distinction clear. An escalation path should identify the decision being escalated, not merely the next job title.
...
Record why a request was declined. Repeated requests may reveal an unmet need that the current plan has undervalued. They may also show that people cannot find the existing capability. [Reviewing software subscriptions](/blog/what-to-ask-before-approving-another-software-subscription) can help distinguish a missing tool from an adoption problem.
