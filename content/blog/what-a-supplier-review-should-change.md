...
The question in [deciding what should stay in-house](/blog/deciding-what-should-stay-in-house) remains relevant even with a good supplier: the organisation needs enough internal capability to judge the work and direct a transition.
...
Feed relevant findings into [future subscription and procurement decisions](/blog/what-to-ask-before-approving-another-software-subscription). A lesson about export limitations or unclear support boundaries should influence the next purchase, not remain trapped in one supplier's minutes.
