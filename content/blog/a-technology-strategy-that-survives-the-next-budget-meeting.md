...
This is where [making the technology budget easier to challenge](/blog/making-the-technology-budget-easier-to-challenge) helps: it separates changes to ambition from changes to existing commitments.
...
Keep the original decision record alongside the new one. It gives the next [quarterly strategy review](/blog/a-practical-way-to-review-your-it-strategy-each-quarter) something more useful than a comparison of slide decks.
