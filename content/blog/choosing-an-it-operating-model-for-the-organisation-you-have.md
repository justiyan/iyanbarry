...
Write down where each party has authority and where agreement is required. [Business ownership in a technology project](/blog/putting-business-ownership-into-a-technology-project) should continue after launch, rather than disappear when the project team closes.
...
Do not assume the person managing support can also provide uninterrupted project leadership. Check the actual pattern of demand. [Making room for improvement](/blog/making-room-for-improvement-without-promising-extra-capacity) requires a realistic account of that variability, not a neat percentage in a role description.
