...
The findings should feed [the pilot's exit decision](/blog/a-pilot-needs-an-exit-decision-not-just-enthusiastic-users): expand, investigate a defined gap, change direction or stop. Retain examples that explain the decision and dispose of unnecessary raw material under the agreed arrangements.
